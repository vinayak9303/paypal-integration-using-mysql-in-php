...
<body>
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=AXCeDAOYCAVNJelf7eav8fqWpsbI-aCKYjQrEwKoktO_htRV_0hh3cyTGBK2xz1wZMhxh0hDPQLS-R2U&disable-funding=credit,card"></script>
    <script id="amount" data-name="<?php echo $amt?>" src="jindex.js"></script>
</body>
</html>
